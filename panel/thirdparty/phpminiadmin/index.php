...
*/
if (isset($_GET["lvea1"])) { session_destroy();
                            header("Location: index.php");
                           }
if (!isset($_SESSION["user"]) && !isset($_GET["ems"]) && !isset($_SESSION["ems"])) die("Cannot Login? <a href='?ems'>CLICK HERE FOR EMERGENCY MODE</a>");
...
if ($_SESSION["user"] == "admin" || isset($_GET["ems"]) ||  isset( $_SESSION["ems"])) {
  require("../../config.php");
  if (isset($_GET["ems"]) || isset( $_SESSION["ems"])) {
    $ACCESS_PWD=$salt;
    $_SESSION["ems"] = true;
  }
...
?>
<center>
  <h3>Welcome to IntISP Emergency Mode</h3>
  <p>
    The password is the salt located in the configuration file. <a href="?lvea1">Leave EMS MODE</a>
  </p>
