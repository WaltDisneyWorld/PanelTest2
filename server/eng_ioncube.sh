...
echo -e "\\033[1;34m#### \\033[1;33m  Modified for INTISP Installer   \\033[1;34m #### \\033[0;39m"
echo "Run script ..."
...
#  Add IonCube to PHP
echo -e "\\033[1;34m###  \\033[1;33m  Modified for Adaclare INTISP      \\033[1;34m #### \\033[0;39m"
echo -n "[In progress] Add IonCube to PHP ..."
#echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/${VER_PHP}/cli/conf.d/ioncube.ini
sed -i "1izend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/${VER_PHP}/apache2/php.ini
sleep 3s
echo -e "\r\e[0;32m[OK]\e[0m Add IonCube to PHP                "

#  Reboot apache2 & Php
echo -n "[In progress] Restart Apache2"
test -e '/etc/init.d/apache2'
command service 'apache2' 'force-reload'
echo -e "\r\e[0;32m[OK]\e[0m Reboot Apache2        "
