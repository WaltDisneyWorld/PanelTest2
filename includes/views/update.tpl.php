...
if ('' != $getVersions and '' != $currentVersion) {
    ...
    foreach ($versionList as $actualVersion) {
        ...
        if ($actualVersion > $currentVersion) {
            ...
            if (isset($_GET['doUpdate']) and true == $_GET['doUpdate']) {
...
function print_message($headline, $message, $color = '')
{
    ...
    echo '<p'.$color.'><b>'.$headline.'</b><br>'.$message.'</p>';
}
function lang($string, $replaceArray = array(), $default = false)
{
    ...
    if (isset($automaticallyScrollToTheBottomOfThePage) and true == $automaticallyScrollToTheBottomOfThePage and 'title' != $string) {
