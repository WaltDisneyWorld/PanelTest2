...
class ServerVariablesController extends Controller
{
    ...
    public function getValueAction()
    {
        ...
        if (isset($this->variable_doc_links[$_GET['varName']][3])
            && 'byte' == $this->variable_doc_links[$_GET['varName']][3]
        ) {
    ...
    public function setValueAction()
    {
        ...
        if (isset($this->variable_doc_links[$_POST['varName']][3])
            && 'byte' == $this->variable_doc_links[$_POST['varName']][3]
            && preg_match(
    ...
    private function _formatVariable($name, $value)
    {
        ...
        if (is_numeric($value)) {
            if (isset($this->variable_doc_links[$name][3])
                && 'byte' == $this->variable_doc_links[$name][3]
            ) {
