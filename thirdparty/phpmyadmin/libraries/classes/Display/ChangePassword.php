...
class ChangePassword
{
    ...
    public static function getHtml($mode, $username, $hostname)
    {
        ...
        $is_privileges = 'server_privileges.php' === basename($_SERVER['SCRIPT_NAME']);
        ...
        if (false !== strpos($GLOBALS['PMA_PHP_SELF'], 'server_privileges')) {
        ...
        if (('MySQL' == $serverType
            ...
            if (('MySQL' == $serverType
                && $serverVersion >= 50706)
                || ($GLOBALS['dbi']->isSuperuser() && 'edit_other' == $mode)
            ) {
                ...
                $html .= '<div'
                    .('sha256_password' != $orig_auth_plugin
                        ? ' class="hide"'
                        : '')
