 ...
 */
if (isset($_POST['output_format']) && 'sendit' == $_POST['output_format']) {
...
} elseif ('database' == $export_type && strlen($db) > 0) {
...
} elseif ('table' == $export_type && strlen($db) > 0 && strlen($table) > 0) {
