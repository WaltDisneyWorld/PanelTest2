...
$l['notes_mysql57'] = 'Please take NOTE of the following points before Installing MySQL 5.7 Or MariaDB 10.1 :';
$l['note_mysql57_backup'] = 'If Database exist, a backup will be taken in <b>'.$globals['ampps_path']. DIRECTORY_SEPARATOR .'temp\</b>';
$l['note_mysql57_downgrade'] = 'You can not Downgrade to MySQL-5.5.';
$l['note_mysql57_upgrade'] = 'Upgrade is only possible for MySQL-5.5.';
$l['note_mysql57_time'] = 'Installation may take a while depending on your Network Speeds.';
$l['note_remove'] = 'It will also remove mysql database.';
?>