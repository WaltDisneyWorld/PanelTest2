...
$l['force_auto_upgrade'] ='Automatisches Update für Benutzer Installationen erzwingen';
$l['force_auto_upgrade_exp'] ='Wenn diese Option gesetzt ist, wird die Checkbox ausgewählt und im Endbenutzer Panel deaktiviert. Endbenutzer können die Option <b>nicht<b> dann nicht mehr ändern.';
$l['enable_auto_upgrade'] = 'Checkbos für automatisches Update standardmäßig aktivieren';
$l['enable_auto_upgrade_exp'] = 'Wenn diese Option gesetzt ist, wird die Checkbox für automatische Updates im Endbenutzer Panel standardmäßig aktiviert sein. Die Endbneutzer können die Option ändern.';
