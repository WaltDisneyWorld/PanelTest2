...
$l['select_files_exp'] = 'Bitte wählen Sie alle weiteren Dateien/Verzeichnisse aus, die mit dieser Installation verbunden sind. <br />Diese Liste wird für Vorgänge wie das Klonen oder Sichern dieser Installation verwendet';
