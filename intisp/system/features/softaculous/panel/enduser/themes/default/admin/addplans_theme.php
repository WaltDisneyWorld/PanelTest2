	...
	foreach($_resellers as $k => $v){
		...
		echo '<div class="col-sm-3 script_choose" id="td_'.$k.'">
				<div class="row">
					...
					<a href="javascript:void(0)" style="text-decoration: none; " onclick="selectchkbox(\''.$k.'\',\'resellers_\');"><font class="sai_bboxtxt">'.$k.'</font></a>
				</div>
			</div>';
...
echo '<p align="center"><input type="submit" name="saveplan" value="'.$l['saveplan'].'" class="flat-butt"></p>'.(empty($globals['lictype']) ? '<div class="sai_notebox">'.$l['feature_not_available'].'</div>' : '').'<br />
</div>	
</div>
</form><br />';
