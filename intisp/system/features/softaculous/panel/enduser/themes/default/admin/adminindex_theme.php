...
<div class="bg2"><br />';
	...
	if(!empty($sitepad_installed)){
		echo '<div class="container-fluid"><div class="alert alert-success text-center"><a href="#" class="close" data-dismiss="alert">&times;</a><img src="'.$theme['images'].'success.gif" /> SitePad installation has started in background, your users can now access SitePad from their cPanel accounts. </div></div>';
	}
	...
	echo '<div class="row">
		...
		if(!empty($sitepad_col)){
			...
			SitePad is based on a Freemium model with 15 themes in Free version. When your users upgrade to premium version you get commissions. <a href="mailto:sales@softaculous.com">Know more</a>. <br /><br />
