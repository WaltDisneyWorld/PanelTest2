...
function remove_unnecessary_tables_webuzo(){
	...
	for(var i=1; i<=12; i++){
		var hide_chk=0;
		var items=$("#main_table"+i+" .panel-body a").children();
...
$( document ).ready(function() {
		...
		if(panel_order_array != null){
			$.each(panel_order_array, function(key, value){
				$("#"+value).appendTo("#draggablePanelList");
			});
		}
	    	...
	    	placeholder: "highlight_placeholder",
				...
				var panel_id = "panel"+elem_id.substring(10);
...
echo'<div class="row" >
	<div class="col-lg-8" style="text-align:center;" id="draggablePanelList">
		...
		<div class="row" id="panel1">
			<div class="col-sm-12 col-xs-12" id="main_div1">
				<div class="panel panel-default" id="main_table1">
		...
		<div class="row" id="panel2">
			<div class="col-xs-12" id="main_div2">
				<div class="panel panel-default" id="main_table2">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel3">
			<div class="col-sm-12 col-xs-12" id="main_div3">
				<div class="panel panel-default" id="main_table3">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel4">
			<div class="col-sm-12 col-xs-12" id="main_div4">
				<div class="panel panel-default" id="main_table4">
					<div class="panel-heading webuzohead">
		...
		if(!$softpanel->getacl('DISABLE_EMAIL')){
			echo '<div class="row" id="panel6">		
				<div class="col-sm-12 col-xs-12" id="main_div6">
					<div class="panel panel-default"  id="main_table6">
						<div class="panel-heading webuzohead">
						...
						<div class="panel-body pad0">';
							...
							<a href="javascript:void(0)" onclick="is_app_inst(36, \'squirrel\'); return;">
								<div class="col-sm-2 col-xs-6 pan-button" id="webuzo_icons64" value="'.$l['webuzo_squirrel'].'">
									<img src="'.$theme['a_images'].'squirrel.png" alt="" width="36" /><br>
									<span class="medium" >'.$l['webuzo_squirrel'].'</span>
								</div>
							</a>
		...
		if(empty($disable_sysapps)){
			echo '
		<div class="row" id="panel7">
			<div class="col-sm-12 col-xs-12" id="main_div7">
				<div class="panel panel-default"  id="main_table7">
					<div class="panel-heading webuzohead">
			...
			echo '
		<div class="row" id="panel8">
			<div class="col-sm-12 col-xs-12" id="main_div8">
				<div class="panel panel-default"  id="main_table8">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel9">
			<div class="col-sm-12 col-xs-12" id="main_div9">
				<div class="panel panel-default" id="main_table9">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel10">
			<div class="col-sm-12 col-xs-12" id="main_div10">
				<div class="panel panel-default" id="main_table10">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel11">
			<div class="col-sm-12 col-xs-12" id="main_div11">
				<div class="panel panel-default" id="main_table11">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel5">
			<div class="col-sm-12 col-xs-12" id="main_div5">';
				$tmpapps = $apps;
				...
				if(!empty($tmpapps) && empty($disable_sysapps)){	
					shuffle($tmpapps);
					echo '<div class="panel panel-default" id="main_table5">
					<div class="panel-heading webuzohead">
		...
		<div class="row" id="panel12">
			<div class="col-sm-12 col-xs-12" id="main_div12">
				<div class="panel panel-default" id="main_table12">
					<div class="panel-heading webuzohead">
