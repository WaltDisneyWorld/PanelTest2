			...
			if(empty($dns_list)){
				...
				foreach ($dns_list as $key => $value){
					echo '<tr id="tr'.$key.'" >
							 ...
							 <td style="width:2%; padding-right:0px; padding-left:0px;"><img title="Cancel" class="cancel" id="cid'.$key.'" src="'.$theme['images'].'del.gif" style="display:none;" /></td>
							 <td style="width:2%; padding-right:0px; padding-left:0px;"><img title="Edit" class="edit" id="eid'.$key.'" src="'.$theme['images'].'editdetail.gif" /></td>
							 <td style="width:2%; padding-right:0px; padding-left:0px;"><img title="Delete" class="delete" id="did'.$key.'" src="' . $theme['images'] . 'remove.gif" /></td>
						 </tr>';
					$i++;
				}
			}
