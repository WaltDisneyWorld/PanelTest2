...
function import_user(user, resp){
	...
	if(user.length > 0){
		...
		$_("responses").innerHTML = $_("responses").innerHTML + \'<div class="container-fluid width80"><div class="sai_heading text-center">'.$l['importing_scripts'].'</div><div class="sai_hr"></div></div><br /><br />\';
