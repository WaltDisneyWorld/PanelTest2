...
<div class="bg"><br />
	...
	if(!empty($deleted)){
		echo '<div class="alert alert-warning" style="padding:10px;font-size:15px;"><center><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>'.$l['backuploc_deleted'].'</center></div>';
	}
