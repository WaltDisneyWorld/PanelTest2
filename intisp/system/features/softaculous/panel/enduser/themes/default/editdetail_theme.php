...
function editdetail_theme(){
	...
	global $insid, $edited, $software, $soft, $scripts, $version_updated, $account_details_editable, $no_autoupgrade, $add_to_fileindex, $__settings, $default_fileindex, $pfx_error, $owned_themes, $full_tables, $default_tables, $no_autoupgrade_acl, $notes;
	...
	if(!empty($edited)){
		...
		echo '<br /><center><b><a href="'.script_link($soft).'&highlight='.$insid.'&postact=edit" class="sai_head">'.$l['return'].'</a></b></center><br />
		</div><!--end of bg-->';
	}else{
							...
							<div class="col-sm-7">
								<div class="row">
									...
									<div class="col-sm-1" style="margin-left:-20px;">
										<input id="toggle_pass_dbpass" type="checkbox" style="display:none;" onclick="toggle_pass(\'show_hide_dbpass\', \'edit_dbpass\');"/><label for="toggle_pass_dbpass" style="margin-top:6px;"><span id="show_hide_dbpass">Show</span></label>
									</div>
								</div>
							</div>						
						</div><br />
