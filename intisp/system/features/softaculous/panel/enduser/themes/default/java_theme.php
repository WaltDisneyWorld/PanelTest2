...
if((empty($globals['default_protocol']) || $globals['default_protocol'] <= 1) && empty($globals['off_checkhttps'])){
	...
	function check_https(){
		$.ajax({
			type: "POST",
			url: "'.$globals['index'].'act=java&soft='.$soft.'&checkhttps="+encodeURIComponent("https://"+$("#softdomain").val()),
			timeout:10000,
...
$info['install'] .= '<div class="row">
<div class="col-sm-5">
	<label class="sai_head">'.$l['choose_domain'].'</label><br />
...
<div class="row">
<div class="col-sm-5">
	<label class="sai_head">'.$l['in_directory'].'</label><br />
