...
<div class="container-fluid width80"><br /><br />
	...
	<div class="sai_form"><br />
		...
		<p align="center"><input type="submit" name="edit_submit" value="'.$l['edit_submit'].'" class="flat-butt" /></p>
	</div>
</div>
</form><br />';
...
echo '<form accept-charset="'.$globals['charset'].'" name="addcs" method="post" action="" class="form-horizontal">
	...
	echo '<div class="row">
		...
		<p align="center"><input type="submit" name="add_submit" value="'.$l['add_submit'].'" class="flat-butt" /></p>
	</div>
</div>	
</form><br />';
