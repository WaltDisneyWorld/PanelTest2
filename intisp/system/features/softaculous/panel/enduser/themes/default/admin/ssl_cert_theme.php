...
if(!empty($updated)){
	echo '<br /><div class="container-fluid"><div class="alert alert-success text-center"><a href="#" class="close" data-dismiss="alert">&times;</a><img src="'.$theme['images'].'success.gif" /> '.$l['save_key'].'</div></div>';
}
